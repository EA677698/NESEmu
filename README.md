...
Currently, RemiNEScent is only compiled using Visual Studio 2022's compiler (MSVC 19.39.33523.0) on Windows, and it is developed initially using CLion as the IDE and is now currently developed on VSCode.
